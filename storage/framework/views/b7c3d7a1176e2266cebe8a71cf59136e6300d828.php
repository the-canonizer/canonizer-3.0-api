            ...
            <table width="100%">
                <tr>
                    <td style="text-align:center; padding:30px 0px;">
                        <img src="<?php echo e(URL::asset('assets/images/OTP-img.png')); ?>">
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table width="100%" style=" background:#fff; padding:0px 30px;" cellpadding="0">
                ...
                <?php if(isset($data['delegated_nick_name_id']) && $data['delegated_nick_name_id'] ){ ?>
                        <td style="padding-top: 0px;  font-weight:400;">
                            <p> <a target="_blank" href="<?php echo e(\App\Facades\Util::linkForEmail($data['nick_name_link'])); ?>"><?php echo e($data['nick_name']); ?></a>
                              has just removed their delegated support from  <a target="_blank" href="<?php echo e(\App\Facades\Util::linkForEmail($data['delegated_nick_name_link'])); ?>"><?php echo e($data['delegated_nick_name']); ?></a> in this topic: <a href="<?php echo e(\App\Facades\Util::linkForEmail($data['topic_link'])); ?>"><b><?php echo e($data['topic_name']); ?></b></a></b>
                            </p>
                        </td>
                <?php }else{  ?>
                    <tr>
                        <td style="padding-top: 0px;  font-weight:400;">
                            <p> <a target="_blank"
                                    href="<?php echo e(\App\Facades\Util::linkForEmail($data['nick_name_link'])); ?>"><?php echo e($data['nick_name']); ?></a>
                                has removed their support from this camp: <a target="_blank" href="<?php echo e(\App\Facades\Util::linkForEmail($data['camp_link'])); ?>"><?php echo e($data['object']); ?></a></b>
                            </p>
                        </td>
                    </tr>
                <?php } ?>
                    ...
                    <td style="padding-top: 0px;  font-weight:400;">
                        <?php if(isset($data['subscriber']) && $data['subscriber'] == 1): ?>
                            ...
                            <ul style="padding-left: 50px;">
                                ...
                                <?php else: ?>
                                    <li>You are subscribed to <a href="<?php echo e(\App\Facades\Util::linkForEmail(url('/') . '/' . $data['camp_url'])); ?>">
                        ...
                        <?php else: ?>
                            ...
                            <ul style="padding-left: 50px;">
                                <?php if(isset($data['support_list']) && count($data['support_list']) > 0): ?>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                    <li>You are directly supporting <a href="<?php echo e(\App\Facades\Util::linkForEmail(url('/') . '/' . $data['camp_url'])); ?>">
                                            <?php echo e($data['camp_name']); ?> </a></li>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/canonizer-3.0-api/resources/views/emails/supportRemovedMail.blade.php ENDPATH**/ ?>