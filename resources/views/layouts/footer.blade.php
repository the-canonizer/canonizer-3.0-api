                ...
                <td class="two-column">
                    ...
                    <tr >
                        ...
                        <a href="javascript:void(0);" style=" font-size:14px; text-decoration:none;     color: #20395A;     line-height: 30px;     vertical-align: bottom;">Follow Us</a>
                            <a href="#"><img src="{{URL::asset('assets/images/instagram.svg') }}" width="28px;" 
                            style="padding-left:10px;"></a>
                            <a href="#"><img src="{{URL::asset('assets/images/facebook.svg') }}" width="28px;" style="padding-left:5px;"></a>
                            <a href="#"><img src="{{URL::asset('assets/images/twitter.svg') }}" width="28px;" style="padding-left:5px;"></a>
                            <a href="#"><img src="{{URL::asset('assets/images/youtube.svg') }}" width="28px;" style="padding-left:5px;"></a>
                            <a href="#"><img src="{{URL::asset('assets/images/linkedin.svg') }}" width="28px;" style="padding-left:5px;"></a>
                        </td>
                    </tr>
                    </table>
                </td>
