...
BEGIN
        ...
        -- CURSOR DECLARATION FOR LIVE CAMPS
       ...
       -- CURSOR DECLARATION FOR LIVE STATEMENTS
...
SET 
    breadcrumb_data = var_parent_hierarchy
WHERE
    topic_num = var_topic_num
        AND camp_num = var_camp_num
...
UPDATE elasticsearch_data 
SET 
    breadcrumb_data = var_statement_parent_hierarchy
WHERE
    topic_num = var_statement_topic_num
