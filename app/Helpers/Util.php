    ...
    */
    ...
    public function updateArchivedCampAndSupport($camp, $archiveFlag = null)
    {
        ...
        if($archiveFlag === 1){            
            ...
            $this->dispatchTimelineJob($topic_num = $topic->topic_num, $camp->camp_num, 1, $message =$timelineMessage, $type="archive_camp", $id=$camp->id, $old_parent_id=null, $new_parent_id=null,$delayCommitTimeInSeconds);   
        }
        ...
        if($archiveFlag === 0){
            ...
            $delayCommitTimeInSeconds = (1*10); //  10 seconds for delay job
            $this->dispatchTimelineJob($topic_num = $topic->topic_num, $camp->camp_num, 1, $message =$timelineMessage, $type="unarchived_camp", $id=$camp->id, $old_parent_id=null, $new_parent_id=null,$delayCommitTimeInSeconds);   
