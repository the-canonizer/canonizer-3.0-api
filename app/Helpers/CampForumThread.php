...
class CampForumThread
{
     ...
     */
    public static function sendEmailToSupporters($topicid, $campnum, $link, $thread_title, $nick_id, $topic_name_encoded)
    {
        $user = '';
        $bcc_user = [];
        $sub_bcc_user = [];
        ...
        $directSupporter = CampForum::getDirectCampSupporter($topicid, $campnum);
