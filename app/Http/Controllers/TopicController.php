...
class TopicController extends Controller
{
    ...
    public function commitAndNotifyChange(Request $request, Validate $validate)
    {
        ...
        try {
            ...
            $totalSupporters = Support::getTotalSupporterByTimestamp('camp', (int)$filter['topicNum'], (int)$filter['campNum'], $model->submitter_nick_id, $model->submit_time, $filter + ['change_id' => $model->id], false)[1];
            if(($ifIamSingleSupporter || $totalSupporters) && !$archiveReviewPeriod) {
