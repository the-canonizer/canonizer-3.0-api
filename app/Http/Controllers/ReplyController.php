    ...
    public function store(Request $request, Validate $validate)
    {
        ...
        try {
            ...
            if ($thread) {
                ...
                CampForum::notifySupportersForumPost($request->topic_num, $request->camp_num, $return_url, $request->body, $request->thread_id, $request->nick_name, $request->topic_name, "", $nickName, config('global.notify.both'));
