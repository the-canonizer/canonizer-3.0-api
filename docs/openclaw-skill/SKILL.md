...
- **Client ID**: `2`
- **Client Secret**: ask the Canonizer team — do not commit it here. Bot accounts do not need it: `/user/login` fills in the password-grant client for users of type `bot`, so email + password is enough.
